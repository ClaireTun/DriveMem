...
NameMapping = {
    ...
    'vehicle.ford.ambulance': 'car',  # 原 van
    ...
    'vehicle.carlamotors.firetruck': 'construction_vehicle',

    # ================= 4. Bus =================
    'vehicle.mercedes.bus': 'bus',
    'vehicle.tata.bus': 'bus',

    # ================= 5. Trailer =================
    # CARLA 默认无动态 trailer，如有静态资产可补充，暂无留空

    # ================= 6. Barrier =================
    'static.prop.barrier': 'barrier',
    'static.fence': 'barrier',
    'static.prop.concretebarrier': 'barrier',
    ...
    # ================= 8. Pedestrian =================
    'walker.pedestrian.0001': 'pedestrian', 'walker.pedestrian.0003': 'pedestrian',
    'walker.pedestrian.0004': 'pedestrian', 'walker.pedestrian.0005': 'pedestrian',
    'walker.pedestrian.0007': 'pedestrian', 'walker.pedestrian.0010': 'pedestrian',
    'walker.pedestrian.0013': 'pedestrian', 'walker.pedestrian.0014': 'pedestrian',
    'walker.pedestrian.0015': 'pedestrian', 'walker.pedestrian.0016': 'pedestrian',
    'walker.pedestrian.0017': 'pedestrian', 'walker.pedestrian.0018': 'pedestrian',
    'walker.pedestrian.0019': 'pedestrian', 'walker.pedestrian.0020': 'pedestrian',
    'walker.pedestrian.0021': 'pedestrian', 'walker.pedestrian.0022': 'pedestrian',
    'walker.pedestrian.0025': 'pedestrian', 'walker.pedestrian.0027': 'pedestrian',
    'walker.pedestrian.0030': 'pedestrian', 'walker.pedestrian.0031': 'pedestrian',
    'walker.pedestrian.0032': 'pedestrian', 'walker.pedestrian.0034': 'pedestrian',
    'walker.pedestrian.0035': 'pedestrian', 'walker.pedestrian.0041': 'pedestrian',
    'walker.pedestrian.0042': 'pedestrian', 'walker.pedestrian.0046': 'pedestrian',
    ...
    # ================= ⚠️ 必须过滤的噪声类 =================
    'traffic.speed_limit.30': 'IGNORE', 'traffic.speed_limit.40': 'IGNORE',
    'traffic.speed_limit.50': 'IGNORE', 'traffic.speed_limit.60': 'IGNORE',
    'traffic.speed_limit.90': 'IGNORE', 'traffic.speed_limit.120': 'IGNORE',
    'traffic.stop': 'IGNORE', 'traffic.yield': 'IGNORE',
    'traffic.traffic_light': 'IGNORE',
    'static.prop.dirtdebris01': 'IGNORE', 'static.prop.dirtdebris02': 'IGNORE',
}
...
# map_classes = {'divider': ['Broken', 'Solid', 'SolidSolid', 'Center'],  
# 'ped_crossing': [],   
# 'boundary': ['TrafficLight', 'StopSign']}
...
ann_file_train=info_root + f"/b2d_infos_train_long.pkl"
